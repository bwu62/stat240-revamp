...
This is also outside the scope of this course, so you **do NOT need to learn it**, but R Markdown also natively supports $\LaTeX$ code. It's rendered using [MathJax](https://www.mathjax.org/), an open-source Javascript engine for typesetting math expressions in webpages. For example, `$$x={-b\pm\sqrt{b^2-4ac} \over 2a}$$`{.latex} becomes:
