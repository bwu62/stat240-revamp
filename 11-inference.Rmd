...
Here's a quick summary of choosing a direction for $H_a$ and how it impacts the p-value computation:
 ...
 - If you suspect $\theta>\theta_0$, choose $H_a:\theta>\theta_0$ and take the **right side** of your sample statistic.

 - If you suspect $\theta<\theta_0$, choose $H_a:\theta<\theta_0$ and take the **left side** of your sample statistic.

 - If you have no suspected side OR if you want to keep both options open, choose $H_a:\theta\ne\theta_0$ and take the **two outer tails** of your sample statistic.
:::
