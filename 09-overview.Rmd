...
text(sum(nodes[1:2,1]*c(.45,.55)),nodes[1,2]+.04,"expand",cex=.9,family="Arial")
text(sum(nodes[2:3,1]*c(.45,.55)),nodes[2,2]+.04,"sample",cex=.9,family="Arial")
text(nodes[6,1]-.082,nodes[6,2]+.14,"iterate",cex=.9,family="Arial")
textrect(nodes[1,],.127,.08,lab="question of interest\n(testable hypothesis)",shadow.size = 0.005,family="Arial")
textrect(nodes[2,],.088,.08,lab="experiment/\nstudy design",shadow.size = 0.005,family="Arial")
textrect(nodes[3,],.065,.06,lab="dataset",shadow.size = 0.005,family="Arial")
textrect(nodes[4,],.1,.06,lab="cleaning/tidying",shadow.size = 0.005,family="Arial")
textrect(nodes[5,],.108,.08,lab="data exploration/\nvisualization",shadow.size = 0.005,family="Arial")
textrect(nodes[6,],.07,.065,lab="modeling",shadow.size = 0.005,family="Arial")
textrect(nodes[7,],.07,.07,lab="parameter\nestimates",shadow.size = 0.005,family="Arial")
textrect(nodes[8,],.07,.07,lab="hypothesis\ntesting",shadow.size = 0.005,family="Arial")
textrect(nodes[9,],.07,.07,lab="confidence\nintervals",shadow.size = 0.005,family="Arial")
textrect(nodes[10,],.07,.06,lab="predictions",shadow.size = 0.005,family="Arial")
textrect(nodes[11,],.075,.07,lab="etc...(further\ninference)",shadow.size = 0.005,family="Arial")
```
:::
