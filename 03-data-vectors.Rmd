...
Ok, let's start the demo by creating a date object. Let's use today's date (which is `r .date` as of [last compile](https://github.com/bwu62/stat240-revamp/commits/master)) as an example. The `today()` function is handy here.
