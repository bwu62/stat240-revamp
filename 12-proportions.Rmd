...
We saw in our sample $\hat p=`r phat`$ was quite close to what we expected under a fair die of $p=0.4$. Let's formally test this using a hypothesis test.

Recall from the previous section if we have no
