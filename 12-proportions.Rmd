...
We can see now that $x_1=`r th[1,2]`$, $x_2=`r th[2,2]`$, $n_1=`r th[1,3]`$, $n_2=`r th[2,3]`$, $\hat p_1=`r round(th[1,4],3)`$, $\hat p_2=`r round(th[2,4],3)`$.
