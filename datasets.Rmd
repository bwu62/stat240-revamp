...
```{r,eval=T,echo=F}
penguins <- read_csv("data/penguins_complete.csv")
```
...
```{r,eval=T,include=F}
fertility.meta <- read_csv("data/fertility_meta.csv")
fertility.raw <- read_csv("data/fertility_raw.csv")
```
