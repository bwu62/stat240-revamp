...
I also briefly needed a nice time series dataset with more than 1 groups to demonstrate line plots. Eventually I settled on [table 303.10](https://nces.ed.gov/programs/digest/d25/tables/dt25_303.10.asp) of the National Center for Education Statistics (NCES) which contains historic college enrollment data, stratified by sex.
